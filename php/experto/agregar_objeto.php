...
include '../caracteristica/botones.php';
$message = include '../controllers/insertar.php';
?>
<!DOCTYPE html>
<html lang="es">
...
<body class="d-flex flex-column min-vh-100">
    <div class="container mt-4">
        <h1 class="text-center mb-4">Datos Objeto</h1>
        ...
        <form method="POST" enctype="multipart/form-data" action="../../php/experto/agregar_objeto.php">       
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea style="font-size: 20px;" class="form-control" id="descripcion" name="descripcion"
                            rows="4"><?= $registroActual['descripcion'] 
                        ?? '' ?></textarea>
                    </div>
                </div>
